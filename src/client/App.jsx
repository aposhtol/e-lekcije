  ...
  return (
    <Container>
      ...
      <Routes>
        ...
        <Route
          path='playlists'
          element={<Playlists grade={grade} filteredList={filteredList} />}
        />
        <Route path='playlists/:id' element={<Videolist grade={grade} />} />
        <Route
